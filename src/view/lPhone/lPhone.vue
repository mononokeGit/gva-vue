<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="IPhone字段" prop="IPhone" width="120" />
        <el-table-column align="left" label="领导姓名" prop="lName" width="120" />
        <el-table-column sortable align="left" label="领导序号" prop="lNum" width="120" />
        <el-table-column align="left" label="备注" prop="lOther" width="120" />
        <el-table-column align="left" label="领导职务" prop="lTitle" width="120" />
        <el-table-column align="left" label="所属单位" prop="lUnit" width="120" />
        <el-table-column align="left" label="更新者" prop="updatedBy" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateLPhoneFunc(scope.row)">变更</el-button>
...
const getTableData = async() => {
  const table = await getLPhoneList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
