    ...
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline" @keyup.enter="onSubmit">
        <el-form-item label="申请时间">
          <el-date-picker v-model="searchInfo.startCreatedAt" placeholder="开始时间" type="datetime"></el-date-picker>
          —
          <el-date-picker v-model="searchInfo.endCreatedAt" placeholder="结束时间" type="datetime"></el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="使用时间">
          ...
          <el-date-picker v-model="searchInfo.startApptime" placeholder="搜索条件（起）" type="datetime"></el-date-picker>
          —
          <el-date-picker v-model="searchInfo.endApptime" placeholder="搜索条件（止）" type="datetime"></el-date-picker>
